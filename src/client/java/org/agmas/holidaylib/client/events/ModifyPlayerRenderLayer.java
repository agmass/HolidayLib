...
public interface ModifyPlayerRenderLayer {

    Event<ModifyPlayerRenderLayer> EVENT = createArrayBacked(ModifyPlayerRenderLayer.class, listeners -> (player,texture) -> {
        int highestPriority = -100000;
        Entry layer = null;
        for (ModifyPlayerRenderLayer listener : listeners) {
